...
data class CommandsConfig(
    ...
    companion object {
        ...
        fun defaultCommandEntries(): Map<String, CommandMetadata> = linkedMapOf(
            ...
            "say" to CommandMetadata("say <msg> or '<msg>", "Speak to the room", "communication"),
            "emote" to CommandMetadata("emote <msg>", "Perform an emote", "communication"),
            "pose" to CommandMetadata("pose <msg>", "Strike a pose", "communication"),
            "who" to CommandMetadata("who", "List online players", "communication"),
            "tell" to CommandMetadata("tell/t <player> <msg>", "Private message a player", "communication"),
            "whisper" to CommandMetadata("whisper/wh <player> <msg>", "Whisper to a player", "communication"),
            "gossip" to CommandMetadata("gossip/gs <msg>", "Global chat channel", "communication"),
            "shout" to CommandMetadata("shout/sh <msg>", "Shout to your zone", "communication"),
            "ooc" to CommandMetadata("ooc <msg>", "Out-of-character channel", "communication"),
            ...
            "wear" to CommandMetadata("wear/equip <item>", "Equip an item", "items"),
            "remove" to CommandMetadata("remove/unequip <slot>", "Unequip from a slot", "items"),
            "get" to CommandMetadata("get/take/pickup <item>", "Pick up an item", "items"),
            "drop" to CommandMetadata("drop <item>", "Drop an item", "items"),
            "use" to CommandMetadata("use <item>", "Use a consumable item", "items"),
            "give" to CommandMetadata("give <item> <player>", "Give an item to a player", "items"),
            "talk" to CommandMetadata("talk <npc>", "Start a conversation with an NPC", "social"),
            "kill" to CommandMetadata("kill <mob>", "Attack a mob", "combat"),
            "flee" to CommandMetadata("flee", "Attempt to flee combat", "combat"),
            "cast" to CommandMetadata("cast/c <spell> [target]", "Cast a spell or ability", "combat"),
            ...
            "buy" to CommandMetadata("buy <item>", "Purchase from a shop", "shops"),
            "sell" to CommandMetadata("sell <item>", "Sell to a shop", "shops"),
            "quest_log" to CommandMetadata("quest log/list", "View active quests", "quests"),
            "quest_info" to CommandMetadata("quest info <name>", "Quest details", "quests"),
            "quest_abandon" to CommandMetadata("quest abandon <name>", "Abandon a quest", "quests"),
            "accept" to CommandMetadata("accept <quest>", "Accept a quest from an NPC", "quests"),
            "achievements" to CommandMetadata("achievements/ach", "View achievements", "quests"),
            "group_invite" to CommandMetadata("group invite <player>", "Invite to your group", "groups"),
            ...
            "group_kick" to CommandMetadata("group kick <player>", "Kick from group", "groups"),
            "group_list" to CommandMetadata("group list (or just 'group')", "List group members", "groups"),
            "gtell" to CommandMetadata("gtell/gt <message>", "Group chat", "groups"),
            "guild_create" to CommandMetadata("guild create <name> <tag>", "Create a guild", "guilds"),
            "guild_disband" to CommandMetadata("guild disband", "Disband your guild", "guilds"),
            "guild_invite" to CommandMetadata("guild invite <player>", "Invite to guild", "guilds"),
            ...
            "guild_kick" to CommandMetadata("guild kick <player>", "Remove from guild", "guilds"),
            "guild_promote" to CommandMetadata("guild promote <player>", "Promote a member", "guilds"),
            "guild_demote" to CommandMetadata("guild demote <player>", "Demote a member", "guilds"),
            "guild_motd" to CommandMetadata("guild motd <message>", "Set guild message of the day", "guilds"),
            ...
            "gchat" to CommandMetadata("gchat/g <message>", "Guild chat", "guilds"),
            "gather" to CommandMetadata("gather/harvest/mine <node>", "Gather from a resource node", "crafting"),
            "craft" to CommandMetadata("craft/make <recipe>", "Craft an item from a recipe", "crafting"),
            ...
            "open" to CommandMetadata("open <door|container>", "Open a door or container", "world"),
            "close" to CommandMetadata("close <door|container>", "Close a door or container", "world"),
            "unlock" to CommandMetadata("unlock <door|container>", "Unlock with a key", "world"),
            "lock" to CommandMetadata("lock <door|container>", "Lock with a key", "world"),
            "search" to CommandMetadata("search <container>", "Search a container for its contents", "world"),
            "get_from" to CommandMetadata("get <item> from <container>", "Take an item from a container", "world"),
            "put_in" to CommandMetadata("put <item> <container>", "Place an item in a container", "world"),
            "pull" to CommandMetadata("pull <lever>", "Pull a lever or object", "world"),
            "read" to CommandMetadata("read <sign>", "Read a sign or inscription", "world"),
            "title" to CommandMetadata("title <titleName> | title clear", "Set or clear your title", "progression"),
            "gender" to CommandMetadata("gender <option>", "Set your gender", "progression"),
            ...
            // Staff commands
            "goto" to CommandMetadata("goto <zone:room | room | zone:>", "Teleport to a room", "admin", staff = true),
            "transfer" to CommandMetadata("transfer <player> <room>", "Move a player", "admin", staff = true),
            "spawn" to CommandMetadata("spawn <mob-template>", "Spawn a mob", "admin", staff = true),
            "smite" to CommandMetadata("smite <player|mob>", "Instantly kill a target", "admin", staff = true),
            "staff_kick" to CommandMetadata("kick <player>", "Disconnect a player", "admin", staff = true),
            "dispel" to CommandMetadata("dispel <player|mob>", "Remove all effects", "admin", staff = true),
            "setlevel" to CommandMetadata("setlevel <player> <level>", "Set a player's level", "admin", staff = true),

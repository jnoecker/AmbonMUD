...
data class SerializedPlayerState(
    ...
    val maxHp: Int,
    val baseMaxHp: Int,
    val strength: Int = PlayerState.BASE_STAT,
    val dexterity: Int = PlayerState.BASE_STAT,
    val constitution: Int = PlayerState.BASE_STAT,
    val intelligence: Int = PlayerState.BASE_STAT,

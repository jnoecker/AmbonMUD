...
class GameMetrics(
    ...
    companion object {
        ...
        val KNOWN_GAME_EVENTS: Map<String, Set<String>> = mapOf(
            ...
            "tavern" to setOf("lottery_ticket", "gamble", "gamble_win", "gamble_coin"),
            ...
            "mail" to setOf("sent", "claimed"),
            "ability" to setOf("cast"),
            "flight" to setOf("discover", "travel"),
            "boat" to setOf("travel"),
            "jukebox" to setOf("play", "queue"),
            "musicbox" to setOf("play", "stop"),
            "akathavae" to setOf(
                "pledge",
                "renounce",
                "illuminate_fail",
                "illuminate_talked_out",
                "sketch_start",
                "sketch_cancel",
                "world_first",
                "world_first_slain",
